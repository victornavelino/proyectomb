...
public class SuperInternalFrame extends javax.swing.JInternalFrame implements ActionListener {

    public SuperInternalFrame() throws HeadlessException {
        super();
    ...
    public SuperInternalFrame(String title) throws HeadlessException {
        super(title);
    }
}
