 ...
 * @author hugo
 */
public class DiagClientePersona extends javax.swing.JDialog {
    ...
    private void initComponents() {
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder(org.openide.util.NbBundle.getMessage(DiagClientePersona.class, "DiagClientePersona.jPanel1.border.title"))); // NOI18N

        lbTipoDNI.setText(org.openide.util.NbBundle.getMessage(DiagClientePersona.class, "DiagClientePersona.lbTipoDNI.text")); // NOI18N

        cboTipoDoc.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Item 1", "Item 2", "Item 3", "Item 4" }));

        lbDocumento.setText(org.openide.util.NbBundle.getMessage(DiagClientePersona.class, "DiagClientePersona.lbDocumento.text")); // NOI18N

        tfDocumento.setText(org.openide.util.NbBundle.getMessage(DiagClientePersona.class, "DiagClientePersona.tfDocumento.text")); // NOI18N
        ...
        lbNombre.setText(org.openide.util.NbBundle.getMessage(DiagClientePersona.class, "DiagClientePersona.lbNombre.text")); // NOI18N

        tfNombre.setText(org.openide.util.NbBundle.getMessage(DiagClientePersona.class, "DiagClientePersona.tfNombre.text")); // NOI18N

        tfApellido.setText(org.openide.util.NbBundle.getMessage(DiagClientePersona.class, "DiagClientePersona.tfApellido.text")); // NOI18N

        lbApellido.setText(org.openide.util.NbBundle.getMessage(DiagClientePersona.class, "DiagClientePersona.lbApellido.text")); // NOI18N

        jPanel2.setBorder(javax.swing.BorderFactory.createTitledBorder(org.openide.util.NbBundle.getMessage(DiagClientePersona.class, "DiagClientePersona.jPanel2.border.title"))); // NOI18N

        jLabel5.setText(org.openide.util.NbBundle.getMessage(DiagClientePersona.class, "DiagClientePersona.jLabel5.text")); // NOI18N

        tfCalle.setText(org.openide.util.NbBundle.getMessage(DiagClientePersona.class, "DiagClientePersona.tfCalle.text")); // NOI18N

        jLabel6.setText(org.openide.util.NbBundle.getMessage(DiagClientePersona.class, "DiagClientePersona.jLabel6.text")); // NOI18N

        tfNumero.setText(org.openide.util.NbBundle.getMessage(DiagClientePersona.class, "DiagClientePersona.tfNumero.text")); // NOI18N

        jLabel7.setText(org.openide.util.NbBundle.getMessage(DiagClientePersona.class, "DiagClientePersona.jLabel7.text")); // NOI18N

        tfPiso.setText(org.openide.util.NbBundle.getMessage(DiagClientePersona.class, "DiagClientePersona.tfPiso.text")); // NOI18N

        jLabel8.setText(org.openide.util.NbBundle.getMessage(DiagClientePersona.class, "DiagClientePersona.jLabel8.text")); // NOI18N

        tfDpto.setText(org.openide.util.NbBundle.getMessage(DiagClientePersona.class, "DiagClientePersona.tfDpto.text")); // NOI18N

        jLabel9.setText(org.openide.util.NbBundle.getMessage(DiagClientePersona.class, "DiagClientePersona.jLabel9.text")); // NOI18N

        jLabel10.setText(org.openide.util.NbBundle.getMessage(DiagClientePersona.class, "DiagClientePersona.jLabel10.text")); // NOI18N

        jLabel11.setText(org.openide.util.NbBundle.getMessage(DiagClientePersona.class, "DiagClientePersona.jLabel11.text")); // NOI18N

        tfCodigoPostal.setText(org.openide.util.NbBundle.getMessage(DiagClientePersona.class, "DiagClientePersona.tfCodigoPostal.text")); // NOI18N
        ...
        jLabel16.setText(org.openide.util.NbBundle.getMessage(DiagClientePersona.class, "DiagClientePersona.jLabel16.text")); // NOI18N
        ...
        jLabel17.setText(org.openide.util.NbBundle.getMessage(DiagClientePersona.class, "DiagClientePersona.jLabel17.text")); // NOI18N

        tfEntreCalles.setText(org.openide.util.NbBundle.getMessage(DiagClientePersona.class, "DiagClientePersona.tfEntreCalles.text")); // NOI18N
        ...
        jLabel18.setText(org.openide.util.NbBundle.getMessage(DiagClientePersona.class, "DiagClientePersona.jLabel18.text")); // NOI18N

        tfReferencia.setText(org.openide.util.NbBundle.getMessage(DiagClientePersona.class, "DiagClientePersona.tfReferencia.text")); // NOI18N

        jLabel19.setText(org.openide.util.NbBundle.getMessage(DiagClientePersona.class, "DiagClientePersona.jLabel19.text")); // NOI18N

        tfBarrio.setText(org.openide.util.NbBundle.getMessage(DiagClientePersona.class, "DiagClientePersona.tfBarrio.text")); // NOI18N
        ...
        jLabel12.setText(org.openide.util.NbBundle.getMessage(DiagClientePersona.class, "DiagClientePersona.jLabel12.text")); // NOI18N

        tfCuil.setText(org.openide.util.NbBundle.getMessage(DiagClientePersona.class, "DiagClientePersona.tfCuil.text")); // NOI18N

        lbSexo.setText(org.openide.util.NbBundle.getMessage(DiagClientePersona.class, "DiagClientePersona.lbSexo.text")); // NOI18N

        cboSexo.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Item 1", "Item 2", "Item 3", "Item 4" }));

        jPanel3.setBorder(javax.swing.BorderFactory.createTitledBorder(org.openide.util.NbBundle.getMessage(DiagClientePersona.class, "DiagClientePersona.jPanel3.border.title"))); // NOI18N

        btnAgregarTelefono.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagenes/add.png"))); // NOI18N
        btnAgregarTelefono.setText(org.openide.util.NbBundle.getMessage(DiagClientePersona.class, "DiagClientePersona.btnAgregarTelefono.text")); // NOI18N
        ...
        btnEliminarTelefono.setText(org.openide.util.NbBundle.getMessage(DiagClientePersona.class, "DiagClientePersona.btnEliminarTelefono.text")); // NOI18N
        ...
        jPanel5.setBorder(javax.swing.BorderFactory.createTitledBorder(org.openide.util.NbBundle.getMessage(DiagClientePersona.class, "DiagClientePersona.jPanel5.border.title"))); // NOI18N

        btnAgregarCorreoElectronico.setIcon(new javax.swing.ImageIcon(getClass().getResource("/Imagenes/add.png"))); // NOI18N
        btnAgregarCorreoElectronico.setText(org.openide.util.NbBundle.getMessage(DiagClientePersona.class, "DiagClientePersona.btnAgregarCorreoElectronico.text")); // NOI18N
        ...
        btnEliminarCorreoElectronico.setText(org.openide.util.NbBundle.getMessage(DiagClientePersona.class, "DiagClientePersona.btnEliminarCorreoElectronico.text")); // NOI18N
        ...
        lbRazonSocial.setText(org.openide.util.NbBundle.getMessage(DiagClientePersona.class, "DiagClientePersona.lbRazonSocial.text")); // NOI18N

        tfRazonSocial.setText(org.openide.util.NbBundle.getMessage(DiagClientePersona.class, "DiagClientePersona.tfRazonSocial.text")); // NOI18N

        jLabel1.setText(org.openide.util.NbBundle.getMessage(DiagClientePersona.class, "DiagClientePersona.jLabel1.text")); // NOI18N

        cboListaPrecio.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Item 1", "Item 2", "Item 3", "Item 4" }));

        jPanel4.setBorder(javax.swing.BorderFactory.createTitledBorder(org.openide.util.NbBundle.getMessage(DiagClientePersona.class, "DiagClientePersona.jPanel4.border.title"))); // NOI18N

        chactivar.setText(org.openide.util.NbBundle.getMessage(DiagClientePersona.class, "DiagClientePersona.chactivar.text")); // NOI18N
        ...
        lbFechaNac.setText(org.openide.util.NbBundle.getMessage(DiagClientePersona.class, "DiagClientePersona.lbFechaNac.text")); // NOI18N
        ...
        jLabel2.setText(org.openide.util.NbBundle.getMessage(DiagClientePersona.class, "DiagClientePersona.jLabel2.text")); // NOI18N
        ...
        btnAceptar.setText(org.openide.util.NbBundle.getMessage(DiagClientePersona.class, "DiagClientePersona.btnAceptar.text")); // NOI18N
    ...
    private boolean validarPersona2() {
        ...
        if (tfApellido.getText().isEmpty()) {
            ...
            flag = false;
        } else if (ClienteFacade.getInstance().buscarDniPersonaCentral(tfDocumento.getText().trim()) && tipoOperacion.equals("AltaPersona")) {
...
//        persona.setDomicilio(domicilio);
    ...
    private void cargarOrganismo() {
        ...
        try {
            if (organismo.getDomicilio().getLocalidad() != null) {
                cboLocalidades.setSelectedItem(organismo.getDomicilio().getLocalidad());
            }
        } catch (java.lang.NullPointerException ex) {
        }
